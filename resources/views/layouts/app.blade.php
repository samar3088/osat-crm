...
<div class="flex min-h-screen">
    ...
    {{-- ═══ SIDEBAR ═══ --}}
    <aside id="sidebar"
           class="w-[260px] min-h-screen bg-dark-2 fixed left-0 top-0 flex flex-col z-50 transition-transform duration-300">

        {{-- Logo --}}
        <div class="flex items-center gap-3 px-5 py-[22px] border-b border-white/[0.07]">
            ...
            <div>
                <div class="text-sm font-extrabold text-white leading-tight">Investment CRM</div>
                <div class="text-[10px] text-white/40 font-medium">Wealth Management</div>
            </div>
        </div>
        ...
        <nav class="flex-1 px-3 py-4 overflow-y-auto">
            ...
            {{-- Main --}}
            <div class="text-[10px] font-bold text-white/30 tracking-widest uppercase px-3 mb-2">Main</div>
            ...
            {{-- Management --}}
            <div class="text-[10px] font-bold text-white/30 tracking-widest uppercase px-3 mb-2 mt-4">Management</div>
            ...
            <a href="#"
               class="flex items-center gap-3 px-3 py-2.5 rounded-[10px] mb-1 transition-all text-white/60 hover:bg-white/[0.07] hover:text-white">
                ...
                <span class="text-sm font-semibold">Conveyance</span>
            </a>
            @endcan

            {{-- Reports --}}
            <div class="text-[10px] font-bold text-white/30 tracking-widest uppercase px-3 mb-2 mt-4">Reports</div>
            ...
            {{-- Tools --}}
            <div class="text-[10px] font-bold text-white/30 tracking-widest uppercase px-3 mb-2 mt-4">Tools</div>
            ...
            <a href="#"
               class="flex items-center gap-3 px-3 py-2.5 rounded-[10px] mb-1 transition-all text-white/60 hover:bg-white/[0.07] hover:text-white">
                ...
                <span class="text-sm font-semibold">Calculators</span>
            </a>

            {{-- Admin Only --}}
            @can('manage settings')
            <div class="text-[10px] font-bold text-white/30 tracking-widest uppercase px-3 mb-2 mt-4">Admin</div>
